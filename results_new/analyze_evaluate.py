...
df = pd.read_csv('../data/predictions_evaluate.tsv', sep='\t')
...
filtered_df.to_csv('filtered_predictions_evaluate.tsv', sep='\t', index=False)

print("\nFiltered data saved to 'filtered_predictions_evaluate.tsv'")
...
accuracy_df.to_csv('accuracy_by_target_evaluate.tsv', sep='\t', index=False)
print("\nAccuracy analysis saved to 'accuracy_by_target_evaluate.tsv'")